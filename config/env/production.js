...
module.exports = {
  ...
  datastores: {
     ...
     ***************************************************************************/
    default: {
      url: "mongodb://ifeanyi:anyibaba2017@mongodb-4033-0.cloudclusters.net:10001/My-Hobby-App?authSource=admin",
      //--------------------------------------------------------------------------
  ...
  security: {
    ...
    cors: {
      allowOrigins: [
        'https://serene-bastion-68831.herokuapp.com',
      ]
    },
  ...
  sockets: {
     ...
     *                                                                          *
     ***************************************************************************/
    onlyAllowOrigins: ["https://afternoon-bayou-91025.herokuapp.com"],
